  ...
  navlistPanel(widths = c(2, 10),
               ...
               tabPanel("1. Linear model",
                        ...
                        column(width = 9,
                               ...
                               br(),
                               tags$p("Marginal plots with three dimensions are typically created when an interaction is suspected.")
                        ...
                        checkboxInput("observed.values.lm1", 
                                      ...
                                      FALSE),
                        br(),
                        tags$p(HTML("On the plot above, it is noticeable that 
                                   the fitted values fall on the regression line. 
                                   This is possible because there are only two variables: 
                                   one continuous and one categorical. 
                                   Therefore, it is possible to control both variables simultaneously,
                                   resulting in the points falling on the regression line.")),
                        br(),
                        tags$p(HTML("On the next panel, you will see that this is not the case anymore. 
                       In fact, we are going to introduce another continuous variable,
                       thus this property will no longer hold, and the points 
                       will not be on the regression line anymore.")),
                        br(),
                        tags$p(HTML("The more influential the variable is on the regression, 
                                   the more the points will fall near regression line.")),
                        br(),
               ...
               tabPanel("2. Linear model",
                        ...
                        column(width = 9,
                               ...
                               tags$p("Marginal plots with three dimensions are
                                      typically created when an interaction is suspected.")
                        ...
                        checkboxInput("observed.values.lm1.5",
                                      "Add observed values",
                                      FALSE),
                        tags$p(HTML("As anticipated in the previous panel,
                                    it is noticeable that the fitted values do not fall on the regression line.")),
                        tags$p(HTML("The variable <em>Fertilizer</em> seems to have
                                    a greater influence on the linear regression 
                                    compared to the variable <em>Plant_height</em>. 
                                    This because the points are better represented 
                                    when the variable <em>Fertilizer</em> is controlled on the x-axis.")),
                        tags$p(HTML("To plot these graphs, the second variable has been setted to its mean value.
                                    Meaning that for the first graph, the mean value of <em>Plant_height</em> 
                                    is taken for all the observations, whereas for the second plot, 
                                    the same is done for <em>Fertilizer</em>.")),
                        tags$p("It is easy to observe that when more than one variable is present in
                               the explanatory variables, the individual effect of each variable 
                               on the response variable becomes less clear."),
                        br(),
                        #useShinyjs(),
               ...
               tabPanel("6. Generalized linear model - Binomial",
                        tags$h3("Generalized linear model - Binomial"),
                        ...
                        tags$p(HTML("<em>Cob_pres</em> is explained by a generalized linear model 
                        ...
                        tags$p(HTML("Cob_pres ~ Fertilizer + Site, 
                                    <span style='color: red;'>family = binomial(link = 'logit')</span>")),
                        br(),
                        fluidRow(
                          column(width = 3,
                        ...
                        bsCollapse(id = "collapsible.glm.bin",
                                   bsCollapsePanel("TA-plot", "This panel shows",
                                                   "the TA-plot for a generalized linear",
               ...
               ## Seventh Panel - Generalized linear model with interactions - binomial -------
               tabPanel("7. Generalized linear model with interactions - Binomial",
                        tags$h3("Generalized linear model with interactions - Binomial"),
                        tags$p(HTML("In this panel <em>Cob_pres</em>
                        is explained by a generalized linear model with logit link function. 
               ...
               ## Eighth Panel - Generalized linear model with quadratic effects - Binomial---------------
               
               tabPanel("8. Generalized linear model with quadratic effects - Binomial",
                        tags$h3("Generalized linear model with quadratic effect - Binomial"),
                        tags$p(HTML("In this panel <em>Cob_pres</em> 
                        is explained by a generalized linear model with logit link function. 
                        The explanatory variables are <em>Fertilizer</em> and <em>Site</em>.")),
               ...
               tabPanel("9. Generalized linear model - Poisson",
                        tags$h3("Generalized linear model - Poisson"),
                        tags$p(HTML("In this panel, the response variable <em>Cob_nb</em> 
                                    represents the count of plants that have germinated.
                                    To analyze this count data, a generalized linear model 
               ...
               ## Tenth Panel - Generalized linear model with interaction - Poisson -----------
               tabPanel("10. Generalized linear model with interaction - Poisson",
                        tags$h3("Generalized linear model with interaction - Poisson"),
                        tags$p(HTML("In this panel <em>Cob_nb</em> (taken as a count)
                        is explained by a generalized linear model with square root as link function. 
                        The explanatory variables are <em>Fertilizer</em> and <em>Site</em>.")),
               ...
               ## Twelve panel - violating generalized linear model - binomial -----------------
               
               # tabPanel("Generalized linear model - Binomial",
               ...
               ## Thirteen panel - violating generalized linear model - poisson ---------------
